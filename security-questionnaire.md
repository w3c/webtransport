...
01.  What information might this feature expose to Web sites or other parties,
    ...
    or HTTP/2 sessions to servers. In so doing, this feature exposes the network
    condition and error information about the connection request.
02.  Do features in your specification expose the minimum amount of information
     necessary to enable their intended uses?

    Yes. Also, we're careful to not exposing information for endpoints that
...
05.  Do the features in your specification introduce new state for an origin
    ...
    No. WebTransport doesn't interact with cookies or other persistent
    state.
...
09.  What data do the features in this specification expose to an origin? Please
    ...
    - Arbitrary data and headers sent from the server, (similar to fetch)
...
13.  What temporary identifiers do the features in this specification create or
    ...
    The "pooling" feature allows multiple WebTransport sessions to share a single connection.
    This is very similar to connection reuse in HTTP. The connection may survive navigation.
14.  How does this specification distinguish between behavior in first-party and
    ...
    network partition keys when creating or pooling connections.
...
16.  Does this specification have both "Security Considerations" and "Privacy
    ...
    Yes, but not as separate sections. We have a single section titled "Privacy and Security
    Considerations". 
17.  Do features in your specification enable origins to downgrade default
     security protections?

    No, but the CSP specification adds an unsafe-webtransport-hashes keyword to relax connect-src. 
